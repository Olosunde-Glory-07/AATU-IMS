...
function Avatar({ name, size = 28 }) {
  ...
  return (
    <div style={{
      ...
      color: C.onSurfaceVariant, fontFamily: MONO,
...
export default function AdminJobOrdersPage() {
  ...
  const fetchOrders = useCallback(async () => {
    try {
      ...
      if (error) { console.error("Job orders fetch error:", error.message); showToast("Failed to load job orders."); return; }
