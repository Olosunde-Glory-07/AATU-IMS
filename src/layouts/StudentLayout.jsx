...
import { LayoutDashboard, ClipboardList, History, Bell, User, LogOut } from 'lucide-react'
...
export default function StudentLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-background">
      <aside className="fixed left-0 top-0 h-full w-[260px] bg-[#1a3a5c] text-white flex flex-col z-50 overflow-y-auto">
        <div className="p-6 border-b border-white/10">
          <div className="flex items-center gap-2 font-bold text-lg">
            <span className="material-symbols-outlined" style={{ fontVariationSettings: "'FILL' 1" }}>account_balance</span>
            AATU
          </div>
          <p className="text-xs text-white/60 font-mono">Student Portal</p>
        </div>
