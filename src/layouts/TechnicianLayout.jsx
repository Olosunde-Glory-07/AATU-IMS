...
import { LayoutDashboard, Wrench, Bell, User, LogOut } from 'lucide-react'

const navItems = [
  { to: '/technician/dashboard',     label: 'Dashboard',     icon: LayoutDashboard },
  { to: '/technician/my-jobs',       label: 'My Jobs',       icon: Wrench },
...
export default function TechnicianLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-background">
      <aside className="fixed left-0 top-0 h-full w-[260px] bg-tertiary-container text-white flex flex-col z-50 overflow-y-auto">
        <div className="p-6 border-b border-white/10">
          <div className="flex items-center gap-2 font-bold text-lg">
            <span className="material-symbols-outlined" style={{ fontVariationSettings: "'FILL' 1" }}>account_balance</span>
            AATU
          </div>
          <p className="text-xs text-white/60 font-mono">Technician Portal</p>
        </div>
